//particleDraw /dir/file.hipo Ex2_HipoDraw.C
{
  ...
  hists.Hist1D("P.Time-EVNT.StartTime",1000,-200,200,"P.Time&&PBANK.Px"); //Note zero suppression
  ...
  hists.Hist1D("FTOF1B.Time-EVNT.StartTime",1000,-200,200,"P.Time&&PBANK.Px&&PBANK.Px");
  ...
  hists.Hist1D("P.Time-EVNT.StartTime",1000,-200,200,"P.Time&&P.Pid==11&&PBANK.Px");
  ...
  hists.Hist1D("P.Time-EVNT.StartTime",1000,-200,200,"P.Time&&P.Pid==2212&&PBANK.Px")->Draw("(4x3)");
