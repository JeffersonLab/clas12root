...
void db(){
  ...
  /*For a database to be created you must specify the path to
    ...
    for this purpose*/
  clas12databases::SetCCDBLocalConnection("/scigroup/cvmfs/hallb/clas12/soft/noarch/data/ccdb/ccdb_latest.sqlite");
  //clas12databases::SetRCDBRootConnection("rcdb.root");

  clas12root::HipoChain chain;
  chain.Add("/cache/clas12/rg-a/production/recon/spring2019/torus-1/pass2/dst/train/InclusivePositron/InclusivePositron_006666.hipo");
